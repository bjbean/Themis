...
#### 对象类（Oracle部分）    
![流程图](rule_obj_oracle.png)   

#### 对象类（MySQL部分）    
![流程图](rule_obj_mysql.png)   

#### 执行计划类（Oracle部分）    
![流程图](rule_plan_oracle.png)   

#### 执行计划类（MySQL部分）    
![流程图](rule_plan_mysql.png)   

#### 执行特征类（Oracle部分）    
![流程图](rule_exec_oracle.png)   

#### 执行特征类（MySQL部分）    
![流程图](rule_exec_mysql.png)   

#### 文本类    
![流程图](rule_statement.png)   
